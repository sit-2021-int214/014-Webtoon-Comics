...
#choose : years <- c(2008,2008,2010,2011,2011,2012,rep(2013:2016,each=2),rep(2017,4),rep(2018,2),rep(2019,3),rep(2021,4)) 
#Because This function make it easy to read the frequency of released year
...
count <- table(years) 
count[which(count==max(count))] # 2017 and 2021
